...
namespace JoanZapata.XamarinIconify.Internal
{
    public class IconFontDescriptorWrapper
    {
        ...
        {
            get { return _iconFontDescriptor; }
        }
        ...
        private Typeface CreateTypeface(Context context)
        {
            ...
            var path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "fonts",
                _iconFontDescriptor.FontFileName);
